...
namespace ChargeBee.Models
{
    ...
    public class Export : Resource 
    {
        ...
        public class PriceVariantsRequest : EntityRequest<PriceVariantsRequest> 
        {
            ...
            public EnumFilter<PriceVariant.StatusEnum, PriceVariantsRequest> PriceVariantStatus() 
            {
                return new EnumFilter<PriceVariant.StatusEnum, PriceVariantsRequest>("price_variant[status]", this);        
            }
